...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button5->Location = System::Drawing::Point(195, 392);
			...
			this->button3->Location = System::Drawing::Point(73, 390);
			...
			this->button2->Location = System::Drawing::Point(310, 312);
			...
			this->bttn1->Location = System::Drawing::Point(73, 306);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm14::bttn1_Click);
			// 
			// MyForm14
			// 
			...
			this->Text = L"Level 3 Question 2";
...
#pragma endregion
	void elseMessage()
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 7)   
			{
				MessageBox::Show("Your answer is correct!", "Level 3 Question 2 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information); //change depende sa level & question
				int score = System::Convert::ToInt16(lblscore->Text) + 3;
				lblscore->Text = System::Convert::ToString(score);

				this->Hide();
				MyForm15^ obj1 = gcnew MyForm15(); 
				obj1->ShowDialog();
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 7; 
				lblnum->Text = System::Convert::ToString(result);
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) / 20; 
				lblnum->Text = System::Convert::ToString(result);
	...
	private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 123; 
				lblnum->Text = System::Convert::ToString(result);
