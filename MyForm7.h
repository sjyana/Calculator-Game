...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Location = System::Drawing::Point(6, 15);
			...
			this->button3->Location = System::Drawing::Point(248, 403);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(156, 100);
			this->button3->TabIndex = 9;
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &MyForm7::button3_Click_1);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(95, 400);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(156, 100);
			this->button2->TabIndex = 8;
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &MyForm7::button2_Click_1);
			// 
			// lblscore
			// 
			...
			this->bttn1->Location = System::Drawing::Point(239, 301);
			this->bttn1->Name = L"bttn1";
			this->bttn1->Size = System::Drawing::Size(172, 105);
			this->bttn1->TabIndex = 1;
			this->bttn1->UseVisualStyleBackColor = false;
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm7::bttn1_Click_1);
			// 
			// plus2
			// 
			...
			this->plus2->Location = System::Drawing::Point(97, 305);
			...
			this->plus2->Click += gcnew System::EventHandler(this, &MyForm7::plus2_Click_1);
			// 
			// MyForm7
			// 
			...
			this->Text = L"Level 2 Question 1";
...
#pragma endregion
	...
	void elseMessage()
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 404)
			{
				MessageBox::Show("Your answer is correct!", "Level 2 Question 2 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information); //change depende sa level & question
				int score = System::Convert::ToInt16(lblscore->Text) + 1;
				lblscore->Text = System::Convert::ToString(score);

				this->Hide();
				MyForm8^ obj1 = gcnew MyForm8();
				obj1->ShowDialog();
	...
	private: System::Void plus2_Click_1(System::Object^ sender, System::EventArgs^ e) {
		Console::Beep();
	...
	private: System::Void bttn1_Click_1(System::Object^ sender, System::EventArgs^ e) {
		Console::Beep();
	...
	private: System::Void button3_Click_1(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) * 10;
				lblnum->Text = System::Convert::ToString(result);
