...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Location = System::Drawing::Point(5, 16);
			...
			this->lblgoal->Size = System::Drawing::Size(55, 31);
			this->lblgoal->TabIndex = 3;
			this->lblgoal->Text = L"-10";
			...
			this->bttn1->Location = System::Drawing::Point(90, 340);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm2::bttn1_Click);
			// 
			// bttn2
			// 
			...
			this->bttn2->Location = System::Drawing::Point(249, 340);
			...
			this->bttn2->Click += gcnew System::EventHandler(this, &MyForm2::bttn2_Click);
			// 
			// MyForm2
			// 
			...
			this->Text = L"Level 1 Question 2";
...
#pragma endregion
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == -10)
			{
				MessageBox::Show("Your answer is correct!", "Level1 Question2 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information);
