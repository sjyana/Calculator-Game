...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bttn1->Location = System::Drawing::Point(88, 333);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm4::bttn1_Click);
			// 
			// bttn2
			// 
			...
			this->bttn2->Click += gcnew System::EventHandler(this, &MyForm4::bttn2_Click);
			// 
			// MyForm4
			// 
			...
			this->Text = L"Level 1 Question 4";
...
#pragma endregion
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == -1)
			{
				MessageBox::Show("Your answer is correct!", "Level1 Question4 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information);
