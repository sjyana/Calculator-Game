...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button3->Location = System::Drawing::Point(251, 403);
			...
			this->button2->Location = System::Drawing::Point(97, 399);
			...
			this->bttn1->Location = System::Drawing::Point(252, 304);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm9::bttn1_Click);
			// 
			// plus2
			// 
			...
			this->plus2->Location = System::Drawing::Point(95, 306);
			...
			this->plus2->Click += gcnew System::EventHandler(this, &MyForm9::plus2_Click);
			// 
			// MyForm9
			// 
			...
			this->Text = L"Level 2 Question 3";
...
#pragma endregion
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == -9)   
			{
				MessageBox::Show("Your answer is correct!", "Level 2 Question 3 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information); //change depende sa level & question
				int score = System::Convert::ToInt16(lblscore->Text) + 1;
				lblscore->Text = System::Convert::ToString(score);

				this->Hide();
				MyForm10^ obj1 = gcnew MyForm10(); 
				obj1->ShowDialog();
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) * -1; 
				lblnum->Text = System::Convert::ToString(result);
