...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bttn1->Location = System::Drawing::Point(88, 340);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm3::bttn1_Click);
			// 
			// bttn2
			// 
			...
			this->bttn2->Location = System::Drawing::Point(248, 346);
			...
			this->bttn2->Click += gcnew System::EventHandler(this, &MyForm3::bttn2_Click);
			// 
			// MyForm3
			// 
			...
			this->Text = L"Level 1 Question 3";
...
#pragma endregion
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 5)
			{
				MessageBox::Show("Your answer is correct!", "Level1 Question3 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information);
	...
	private: System::Void bttn1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 15;
				lblnum->Text = System::Convert::ToString(result);
