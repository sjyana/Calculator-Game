...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button3->Location = System::Drawing::Point(249, 401);
			...
			this->button2->Location = System::Drawing::Point(89, 398);
			...
			this->bttn1->Location = System::Drawing::Point(248, 302);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm11::bttn1_Click);
			// 
			// plus2
			// 
			...
			this->plus2->Location = System::Drawing::Point(92, 301);
			...
			this->plus2->Click += gcnew System::EventHandler(this, &MyForm11::plus2_Click);
			// 
			// MyForm11
			// 
			...
			this->Text = L"Level 2 Question 5";
...
#pragma endregion
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 2) 
			{
				MessageBox::Show("Your answer is correct!", "Level 2 Question 5 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information); //change depende sa level & question
	...
	private: System::Void bttn1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 4;
				lblnum->Text = System::Convert::ToString(result);
