...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button6->Location = System::Drawing::Point(313, 393);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(123, 77);
			this->button6->TabIndex = 12;
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &MyForm13::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &MyForm13::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Location = System::Drawing::Point(190, 311);
			...
			this->button3->Location = System::Drawing::Point(72, 390);
			...
			this->button2->Location = System::Drawing::Point(311, 313);
			...
			this->button1->Location = System::Drawing::Point(253, 242);
			...
			this->bttn1->Location = System::Drawing::Point(72, 305);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm13::bttn1_Click);
			// 
			// MyForm13
			// 
			...
			this->Text = L"Level 3 Question 1";
...
#pragma endregion
	...
	private: System::Void bttn1_Click(System::Object^ sender, System::EventArgs^ e) {
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 74)
			{
				MessageBox::Show("Your answer is correct!", "Level 3 Question 1 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information); //change depende sa level & question
				int score = System::Convert::ToInt16(lblscore->Text) + 3;
				lblscore->Text = System::Convert::ToString(score);

				this->Hide();
				MyForm14^ obj1 = gcnew MyForm14();
				obj1->ShowDialog();
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 5;
				lblnum->Text = System::Convert::ToString(result);
