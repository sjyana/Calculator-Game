...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->bttn1->Location = System::Drawing::Point(248, 330);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm5::bttn1_Click);
			// 
			// bttn2
			// 
			...
			this->bttn2->Location = System::Drawing::Point(96, 330);
			...
			this->bttn2->Click += gcnew System::EventHandler(this, &MyForm5::bttn2_Click);
			// 
			// MyForm5
			// 
			...
			this->Text = L"Level 1 Question 5";
...
#pragma endregion
		...
		void elseMessage() //constant. icopy sa lahat ng button. ipaste under ng pragma endregion
		{
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 0)
			{
				MessageBox::Show("Your answer is correct!", "Level1 Passed. You can now proceed to Level 2", MessageBoxButtons::OK, MessageBoxIcon::Information);
	...
	private: System::Void bttn1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) - 9; //baguhin depende sa sign and number ng button
...
private: System::Void bttn2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->lblnum->Text = "0";
		this->lblmoves->Text = "4"; //hanggang dito
	}
};
}
