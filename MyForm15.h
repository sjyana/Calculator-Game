...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MyForm15::panel1_Paint);
			// 
			// button6
			// 
			...
			this->button6->Location = System::Drawing::Point(310, 391);
			...
			this->button5->Location = System::Drawing::Point(190, 389);
			...
			this->button4->Location = System::Drawing::Point(192, 312);
			...
			this->button3->Location = System::Drawing::Point(74, 388);
			...
			this->button2->Location = System::Drawing::Point(310, 314);
			...
			this->button1->Location = System::Drawing::Point(257, 241);
			...
			this->bttn1->Location = System::Drawing::Point(71, 306);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm15::bttn1_Click);
			// 
			// MyForm15
			// 
			...
			this->Text = L"Level 3 Question 3";
...
#pragma endregion
		...
		void elseMessage()
		{
			...
			this->lblnum->Text = "0"; //change depende sa number na nakashow sa screen
			this->lblmoves->Text = "4"; //change depende sa number of moves
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 46) 
			{
				MessageBox::Show("Your answer is correct!", "Level 3 Question 3 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information); //change depende sa level & question
				int score = System::Convert::ToInt16(lblscore->Text) + 3;
				lblscore->Text = System::Convert::ToString(score);

				this->Hide();
				MyForm16^ obj1 = gcnew MyForm16(); //papalitan yung form
				obj1->ShowDialog();
	...
	private: System::Void bttn1_Click(System::Object^ sender, System::EventArgs^ e) {
		 Console::Beep(); //start ng copy per button
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 5; //baguhin depende sa sign and number ng button
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 10; //baguhin depende sa sign and number ng button
				lblnum->Text = System::Convert::ToString(result);
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 2; //baguhin depende sa sign and number ng button
				lblnum->Text = System::Convert::ToString(result);
	...
	private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 216; //baguhin depende sa sign and number ng button
				lblnum->Text = System::Convert::ToString(result);
	...
	private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 4; //baguhin depende sa sign and number ng button
				lblnum->Text = System::Convert::ToString(result);
