...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button6->Location = System::Drawing::Point(311, 393);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(123, 77);
			this->button6->TabIndex = 12;
			this->button6->UseVisualStyleBackColor = false;
			this->button6->Click += gcnew System::EventHandler(this, &MyForm16::button6_Click);
			// 
			// button5
			// 
			...
			this->button5->Location = System::Drawing::Point(193, 388);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(120, 77);
			this->button5->TabIndex = 11;
			this->button5->UseVisualStyleBackColor = false;
			this->button5->Click += gcnew System::EventHandler(this, &MyForm16::button5_Click);
			// 
			// button4
			// 
			...
			this->button4->Location = System::Drawing::Point(191, 312);
			...
			this->button3->Location = System::Drawing::Point(73, 389);
			...
			this->button1->Location = System::Drawing::Point(257, 242);
			...
			this->lblmoves->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(214)), static_cast<System::Int32>(static_cast<System::Byte>(40)),
				static_cast<System::Int32>(static_cast<System::Byte>(40)));
			this->lblmoves->Location = System::Drawing::Point(352, 63);
			...
			this->bttn1->Location = System::Drawing::Point(72, 309);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm16::bttn1_Click);
			// 
			// MyForm16
			// 
			...
			this->Text = L"Level 3 Question 4";
...
#pragma endregion
	   ...
	   // {
		...
		void passed()
		{
			...
			if (goalNum == 4) // change goal num   
			{
				MessageBox::Show("Your answer is correct!", "Level 3 Question 4 Passed", MessageBoxButtons::OK, MessageBoxIcon::Information); //change depende sa level & question
				int score = System::Convert::ToInt16(lblscore->Text) + 3;
				lblscore->Text = System::Convert::ToString(score);

				this->Hide();
				MyForm17^ obj1 = gcnew MyForm17();
				obj1->ShowDialog();
	...
	private: System::Void bttn1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) + 16; 
	...
	private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
			if (move > 0) {
				int result = System::Convert::ToInt16(lblnum->Text) % 8; //baguhin depende sa sign and number ng button
				lblnum->Text = System::Convert::ToString(result);
