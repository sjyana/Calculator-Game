...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button3->Location = System::Drawing::Point(255, 406);
			...
			this->button2->Location = System::Drawing::Point(87, 406);
			...
			this->bttn1->Location = System::Drawing::Point(78, 296);
			...
			this->bttn1->Click += gcnew System::EventHandler(this, &MyForm8::bttn1_Click);
			// 
			// plus2
			// 
			...
			this->plus2->Location = System::Drawing::Point(257, 305);
			this->plus2->Name = L"plus2";
			this->plus2->Size = System::Drawing::Size(156, 100);
			this->plus2->TabIndex = 0;
			this->plus2->UseVisualStyleBackColor = false;
			this->plus2->Click += gcnew System::EventHandler(this, &MyForm8::plus2_Click);
			// 
			// MyForm8
			// 
			...
			this->Text = L"Level 2 Question 2";
